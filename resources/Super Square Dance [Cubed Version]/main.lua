...
SONGMAP = {}
table.insert(SONGMAP, {music = "supersquare.mp3"})
...
-- Midi files
buildup1main1 = add_offset(read_midi("buildup1main1.mid", 150.0), 12.0 * 4.0);
buildup1main2 = add_offset(read_midi("buildup1main2.mid", 150.0), 16.0 * 4.0);

drop1kick1 = add_offset(read_midi("drop1kick1.mid", 150.0), 20.0 * 4.0);
drop1kick2 = add_offset(read_midi("drop1kick2.mid", 150.0), 26.0 * 4.0);
drop1kick3 = add_offset(read_midi("drop1kick3.mid", 150.0), 28.0 * 4.0);
drop1kick4 = add_offset(read_midi("drop1kick4.mid", 150.0), 32.0 * 4.0);

kick1bomb = add_offset(read_midi("kick1simple.mid", 150.0), 20.0 * 4.0);

kick1solo = add_offset(read_midi("kick1solo.mid", 150.0), 20.0 * 4.0);

kick2 = add_offset(read_midi("kick2.mid", 150.0), 28.0 * 4.0);

main_melo = read_midi("mainsimple.mid", 150.0);
main_melo_add = read_midi("mainsimpleadd.mid", 150.0);
main1 = add_offset(main_melo_add, 28.0 * 4.0);
main2 = add_offset(main_melo_add, 32.0 * 4.0);

breakkick = read_midi_grouped("break1kickgrouped.mid", 150.0);
breakkick1 = add_offset(breakkick, 36.0 * 4.0);
breaktine1 = add_offset(read_midi("break1tine1.mid", 150.0), 44.0 * 4.0);
breaktine2 = add_offset(read_midi("break1tine2.mid", 150.0), 48.0 * 4.0);
breaktine3 = add_offset(read_midi("break1tine3.mid", 150.0), 52.0 * 4.0);
breaktinesolo = add_offset(read_midi("break1tinesolo.mid", 150.0), 55.0 * 4.0);

buildup2 = read_midi("buildup2main1.mid", 150.0);
buildupclap = read_midi("buildup1main2.mid", 150.0);

drop2kick1 = add_offset(read_midi("drop2kick1.mid", 150.0), 64.0 * 4.0);
drop2kick2 = add_offset(read_midi("drop2kick2.mid", 150.0), 68.0 * 4.0);
drop2kick3 = add_offset(read_midi("drop2kick3.mid", 150.0), 72.0 * 4.0);
drop2kick4 = add_offset(read_midi("drop2kick4.mid", 150.0), 76.0 * 4.0);
drop2kicksolo = read_midi("drop2kicksolo.mid", 150.0);
